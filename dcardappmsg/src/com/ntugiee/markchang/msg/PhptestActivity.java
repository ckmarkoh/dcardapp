...
public class PhptestActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phptest);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				HttpPost request = new HttpPost(Global_Setting.site_url+"login");
				...
				try {
					...
					if(response.getStatusLine().getStatusCode() == 200){
						...
						if(Boolean.parseBoolean(result)){
							Toast.makeText(PhptestActivity.this, "login success", Toast.LENGTH_LONG).show();
							login_back(true);
						}
						else{
					...
					Toast.makeText(PhptestActivity.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
					e.printStackTrace();
				}
			}
		});
